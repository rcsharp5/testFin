...
/***/ function(module, exports, __webpack_require__) {
	...
	/***/ function(module, exports, __webpack_require__) {
		...
		var FronEndLib = function FronEndLib() {
			var self = this;
			var onlineClients = [];
			var clients = [];
			var status = "offline";
			var windowName = fin.desktop.Window.getCurrent().name;
			var RouterClient = __webpack_require__(1);
			RouterClient.addListener(windowName + "FSBLClient", function (err, data) {
				if (err) {
			...
			this.baseService = __webpack_require__(9), this.Clients = {
			...
			this.useClients = function (clients) {
				for (var i = 0; i < clients.length; i++) {
					if (this.Clients[clients[i]] && clients.indexOf(clients[i]) === -1) {
			...
			this.useAllClients = function () {
				for (var key in this.Clients) {
					if (clients.indexOf(key) === -1) {
						if (!this.Clients[key].initialize) {
							continue;
						} //hack for now
						clients.push(key);
					}
			...
			this.addEventListener = function (listenerType, callback) {
				...
				//	validate.args(listenerType, "string");
	...
	/***/ function(module, exports, __webpack_require__) {
		...
		var RouterClientConstructor = __webpack_require__(2);
	...
	/***/ function(module, exports, __webpack_require__) {
		...
		var RouterTransport = __webpack_require__(3);
	...
	/***/ function(module, exports, __webpack_require__) {
		...
		var SystemSettings = __webpack_require__(5);
				...
				if (SystemSettings.validationEnabled()) {
					...
					if ((parmCount + 1) % 2 !== 0) {
						...
						for (var i = 0; i < parmCount; i = i + 2) {
							...
							if ((typeof thisArg === "undefined" ? "undefined" : _typeof(thisArg)) !== thisArgType) {
	...
	/***/ function(module, exports, __webpack_require__) {
		...
		var FSBLUtils = __webpack_require__(4);
	...
	/***/ function(module, exports, __webpack_require__) {
		...
		var Client = function Client(params) {
			...
			this.routerClient = __webpack_require__(1);
	...
	/***/ function(module, exports, __webpack_require__) {
		 ...
		 * @constructor
		 */
		var LinkerClient = function LinkerClient(params) {
			Validate.args(params, "object=") && params && Validate.args2("params.onReady", params.onReady, "function=");
			BaseClient.call(this, params);
			var self = this;
			var links = {};
		...
		function WindowClient(params) {
		  ...
		  */
			this.minimize = function () {
				finWindow.minimize(function () {}, function (err) {
					console.error(err);
				});
			};
			/**
		  ...
		  */
			this.restore = function () {
				...
				finWindow.setBounds(this.options.cachedLeft, this.options.cachedTop, this.options.cachedWidth, this.options.cachedHeight, function () {
					finWindow.addEventListener('bounds-changed', self.boundsChangedListener);
				}, function (err) {
					console.error(err);
				});
		  ...
		  */
			this.maximize = function () {
				...
				finWindow.setBounds(monitorDimensions.left, this.toolbarBottom, monitorDimensions.width, monitorDimensions.height, function () {
					finWindow.addEventListener('bounds-changed', self.boundsChangedListener);
				}, function (err) {
					console.error(err);
				});
		  ...
		  */
			this.injectDOM = function () {
				//for the aesthetics.
				if (document.getElementById('fsbl-header-bar')) {
					return;
				}
		  ...
		  */
			this.compareSavedState = function (params) {
				if (!WorkspaceClient || WorkspaceClient.workspaceIsDirty) {
					return;
				};
					...
					switch (response.data.command) {
						...
						case 'bringToFront':
							finWindow.isShowing(function (isShowing) {
								if (isShowing) {
									finWindow.bringToFront(function () {
							...
							break;
						case 'restore':
							fin.desktop.Window.getCurrent().restore(function () {
