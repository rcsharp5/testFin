...
/***/ function(module, exports, __webpack_require__) {
	...
	exports = function () {
		this.baseService = __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"../dist/services/baseService\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
		this.Clients = {
			RouterClient: __webpack_require__(2),
			StorageClient: __webpack_require__(7),
			launcherClient: __webpack_require__(9)
		};
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var RouterClientConstructor = __webpack_require__(3);
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var RouterTransport = __webpack_require__(4);
	var Utils = __webpack_require__(5);
	var console = new Utils.Console("RouterClient"); // Finsemble console
	
	var Validate = __webpack_require__(6); // Finsemble args validator
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (window.location.hostname === "localhost") { // if localhost then using desktop-local config
		...
		openfinAppConfig = __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"../../configs/desktop-local\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
	} else { // else using desktop-app config
		console.debug("desktop-app config");
		openfinAppConfig = __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"../../configs/desktop-app\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
	}
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */
	var RouterClient = __webpack_require__(2);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Client = function (params) {
		...
		this.routerClient = __webpack_require__(2);
